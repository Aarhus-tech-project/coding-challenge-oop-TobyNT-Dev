...
{
    //unclear how i should implement gold in inventory (which cant be "used") - so i added "Misc. valuable items" which can be "sold" to gain gold, which is stored on character and not in inventory
